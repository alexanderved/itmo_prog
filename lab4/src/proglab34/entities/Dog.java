...
public class Dog extends Entity implements Chaser, Biter, Bindable, Bringable {
    ...
    public Dog(NounWithCases name, int accuracy, String[] attributes) {
    ...
    @Override
    public void beBroughtBy(Bringer bringer) {
        System.out.println(bringer.toString()
            + " привел " + getDescription().accusative()
            + " (" + String.join(", ", getAttributes()) + ").");
    }

    @Override
    public void beUnbroughtBy(Bringer bringer) {
        System.out.println(bringer.toString()
            + " увел " + getDescription().accusative() + ".");
    }
